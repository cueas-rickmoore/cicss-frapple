...
for model in models:
    ...
    while date <= end_date:
        ...
        if draw_contours:
            ...
            path = drawNoDataMap(lons, lats, model, config=no_data, 
                                 **map_options)
